...
//import { Employee } from '../view/admin/employee/EmployeeManager.vue'

//菜单管理
//import MenuManagerVue from '../view/admin/menu/MenuManager.vue'
//用户管理
//import PersonManagerVue from '../view/admin/person/PersonManager.vue'
//角色管理
//import RoleManagerVue from '../view/admin/role/RoleManager.vue'
...
let routes = [
    {
        ...
        children: [
            { name: "首页", path: "/desktop", component: DeskTop },
            { name: "个人信息", path: "/person", component: PersonCenter },
        //   { name: "菜单管理", path: "/menumanager", component: MenuManagerVue },
        ]
    },
