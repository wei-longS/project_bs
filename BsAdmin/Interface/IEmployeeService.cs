...
namespace Interface
{
    ...
    public interface IEmployeeService
    {
        ...
        /// <returns></returns>
        bool Add(EmployeeAdd role, long userId);
        /// <summary>
        /// 修改
        /// </summary>
        /// <param name="role"></param>
        /// <param name="userId"></param>
        /// <returns></returns>
        bool Edit(EmployeeEdit role, long userId);
        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <returns></returns>
        PageInfo GetEmployee(EmployeeReq req);
        ...
        /// <param name="req"></param>
        /// <returns></returns>
        PageInfo GetEmployeeCount(EmployeeReq req);
